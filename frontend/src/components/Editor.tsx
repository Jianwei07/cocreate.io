...
export default function Editor({
  ...
  return (
    <div className="space-y-4">
      {/* Platform Selector and Stats - Stack on mobile */}
      ...
      <Card className="border-2 border-gray-200 dark:border-gray-800">
        <CardContent className="p-2 sm:p-4">
          <Textarea
            ...
            className="min-h-[150px] sm:min-h-[200px] text-base sm:text-lg leading-relaxed resize-none border-none focus-visible:ring-0 p-0"
          />
        </CardContent>
      </Card>

      {/* Post Previews - Collapsible on mobile */}
      <div className="space-y-3">
        ...
        {/* Copy All Button - Full width on mobile */}
        {chunks.length > 0 && (
